...
?>
<!-- wp:group {"tagName":"section","align":"full","style":{"color":{"background":"#111827","text":"#F3F4F6"},"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"var:preset|spacing|colossal","bottom":"var:preset|spacing|colossal"}}},"layout":{"type":"constrained"}} -->
<section class="wp-block-group alignfull has-text-color has-background" style="color:#F3F4F6;background-color:#111827;margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--colossal);padding-bottom:var(--wp--preset--spacing--colossal)"><!-- wp:paragraph {"align":"center","style":{"typography":{"textTransform":"uppercase","fontWeight":"600","letterSpacing":"0.08em"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|medium"}},"color":{"text":"rgba(243,244,246,0.72)"}},"fontSize":"extra-small"} -->
<p class="has-text-align-center has-text-color has-extra-small-font-size" style="color:rgba(243,244,246,0.72);margin-top:0;margin-bottom:var(--wp--preset--spacing--medium);font-weight:600;letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( '04 / By the numbers', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->
...
<p class="has-text-align-center has-text-color has-small-font-size" style="color:rgba(243,244,246,0.72);margin-top:0;margin-bottom:0"><?php echo esc_html__( 'Projects per year, on average', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center","style":{"color":{"text":"rgba(243,244,246,0.72)"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"small"} -->
<p class="has-text-align-center has-text-color has-small-font-size" style="color:rgba(243,244,246,0.72);margin-top:0;margin-bottom:0"><?php echo esc_html__( 'Years working together', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center","style":{"color":{"text":"rgba(243,244,246,0.72)"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"fontSize":"small"} -->
<p class="has-text-align-center has-text-color has-small-font-size" style="color:rgba(243,244,246,0.72);margin-top:0;margin-bottom:0"><?php echo esc_html__( 'Repeat or referral clients', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></section>
<!-- /wp:group -->
