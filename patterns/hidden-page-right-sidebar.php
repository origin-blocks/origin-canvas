<?php
/**
 * Title: Hidden: Page (Right Sidebar)
 * Slug: origin-canvas/hidden-page-right-sidebar
 * Categories: hidden
 * Inserter: no
 *
 * @package Origin
...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--colossal);margin-bottom:var(--wp--preset--spacing--massive)"><!-- wp:columns {"align":"wide","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|extra-large","left":"var:preset|spacing|jumbo"},"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
