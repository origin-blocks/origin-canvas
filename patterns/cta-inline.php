...
<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Want our quarterly notes?', 'origin' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"text-body","fontSize":"regular-plus"} -->
<p class="has-text-body-color has-text-color has-regular-plus-font-size"><?php echo esc_html__( 'Four short letters a year about what we&#8217;re learning, what we made, and what we&#8217;d do differently.', 'origin' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
