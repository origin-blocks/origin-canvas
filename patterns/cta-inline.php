...
<h2 class="wp-block-heading has-display-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Want our quarterly notes?', 'origin-canvas' ); ?></h2>
<!-- /wp:heading -->
