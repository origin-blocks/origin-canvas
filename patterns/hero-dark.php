...
<p class="has-text-align-center has-primary-color has-text-color has-small-font-size" style="margin-bottom:var(--wp--preset--spacing--small);font-weight:500;letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( 'STUDIO · EST. 2018', 'origin' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","level":1,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}},"color":{"text":"#F3F4F6"}}} -->
<h1 class="wp-block-heading has-text-align-center has-text-color" style="margin-top:0;margin-bottom:0;color:#F3F4F6"><?php echo esc_html__( 'Quiet, considered work for businesses that have outgrown a templated site.', 'origin' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","fontSize":"regular-plus"} -->
<p class="has-text-align-center has-regular-plus-font-size"><?php echo esc_html__( 'We make brand identity and websites for small teams that have something to say and don&#8217;t want to shout about it.', 'origin' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'See recent work', 'origin' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline","style":{"border":{"color":"#F3F4F6"},"color":{"text":"#F3F4F6"}}} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-text-color has-border-color wp-element-button" style="border-color:#F3F4F6;color:#F3F4F6"><?php echo esc_html__( 'Email us', 'origin' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></section>
<!-- /wp:group -->
