...
?>
<!-- wp:group {"tagName":"header","align":"full","className":"origin-canvas-landing-header","style":{"border":{"bottom":{"color":"var:preset|color|border","width":"1px"}},"color":{"background":"color-mix(in srgb, var(--wp--preset--color--surface-base) 86%, transparent)"}},"layout":{"type":"constrained"}} -->
<header class="wp-block-group alignfull origin-canvas-landing-header has-background" style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;background-color:color-mix(in srgb, var(--wp--preset--color--surface-base) 86%, transparent)"><!-- wp:group {"align":"wide","style":{"dimensions":{"minHeight":"72px"}},"layout":{"type":"flex","justifyContent":"space-between","verticalAlignment":"center"}} -->
<div class="wp-block-group alignwide" style="min-height:72px"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|compact"}},"layout":{"type":"flex","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-brand-mark"} -->
<div class="wp-block-group origin-canvas-brand-mark"></div>
<!-- /wp:group -->

<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700","letterSpacing":"-0.02em"},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"text-heading","fontSize":"regular-plus"} -->
<p class="has-text-heading-color has-text-color has-regular-plus-font-size" style="margin-top:0;margin-bottom:0;font-weight:700;letter-spacing:-0.02em"><?php echo esc_html__( 'Origin Canvas', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|large"}},"layout":{"type":"flex","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|text-heading"},"typography":{"textDecoration":"none"}}}},"textColor":"text-heading","fontSize":"small"} -->
<p class="has-text-heading-color has-text-color has-link-color has-small-font-size" style="margin-top:0;margin-bottom:0;font-weight:500"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Features', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|text-heading"},"typography":{"textDecoration":"none"}}}},"textColor":"text-heading","fontSize":"small"} -->
<p class="has-text-heading-color has-text-color has-link-color has-small-font-size" style="margin-top:0;margin-bottom:0;font-weight:500"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Patterns', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|text-heading"},"typography":{"textDecoration":"none"}}}},"textColor":"text-heading","fontSize":"small"} -->
<p class="has-text-heading-color has-text-color has-link-color has-small-font-size" style="margin-top:0;margin-bottom:0;font-weight:500"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Style Variations', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|text-heading"},"typography":{"textDecoration":"none"}}}},"textColor":"text-heading","fontSize":"small"} -->
<p class="has-text-heading-color has-text-color has-link-color has-small-font-size" style="margin-top:0;margin-bottom:0;font-weight:500"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Pricing', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|medium"}},"layout":{"type":"flex","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"style":{"typography":{"fontWeight":"500"},"spacing":{"margin":{"top":"0","bottom":"0"}},"elements":{"link":{"color":{"text":"var:preset|color|text-heading"},"typography":{"textDecoration":"none"}}}},"textColor":"text-heading","fontSize":"small"} -->
<p class="has-text-heading-color has-text-color has-link-color has-small-font-size" style="margin-top:0;margin-bottom:0;font-weight:500"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'View demo', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:buttons {"layout":{"type":"flex"}} -->
<div class="wp-block-buttons"><!-- wp:button {"style":{"spacing":{"padding":{"top":"10px","right":"22px","bottom":"10px","left":"22px"}}},"fontSize":"small"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-small-font-size has-custom-font-size wp-element-button" style="padding-top:10px;padding-right:22px;padding-bottom:10px;padding-left:22px"><?php echo esc_html__( 'Download', 'origin-canvas' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></header>
...
<div class="wp-block-group origin-canvas-wire"><!-- wp:group {"className":"origin-canvas-wire-head"} -->
<div class="wp-block-group origin-canvas-wire-head"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-wire-body origin-canvas-wire-body--center","style":{"spacing":{"blockGap":"0"}}} -->
<div class="wp-block-group origin-canvas-wire-body origin-canvas-wire-body--center"><!-- wp:group {"className":"origin-canvas-wire-blk origin-canvas-wire-blk--w60"} -->
<div class="wp-block-group origin-canvas-wire-blk origin-canvas-wire-blk--w60"></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group origin-canvas-wire-body"><!-- wp:group {"className":"origin-canvas-wire-blk origin-canvas-wire-blk--grow2"} -->
<div class="wp-block-group origin-canvas-wire-blk origin-canvas-wire-blk--grow2"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-wire-blk origin-canvas-wire-blk--alt"} -->
<div class="wp-block-group origin-canvas-wire-blk origin-canvas-wire-blk--alt"></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"className":"origin-canvas-wire-body","style":{"spacing":{"blockGap":"0"}}} -->
<div class="wp-block-group origin-canvas-wire-body"><!-- wp:group {"className":"origin-canvas-wire-blk origin-canvas-wire-blk--alt"} -->
<div class="wp-block-group origin-canvas-wire-blk origin-canvas-wire-blk--alt"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-wire-blk origin-canvas-wire-blk--grow2"} -->
<div class="wp-block-group origin-canvas-wire-blk origin-canvas-wire-blk--grow2"></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<!-- wp:group {"className":"origin-canvas-wire-body","style":{"spacing":{"blockGap":"0"}}} -->
<div class="wp-block-group origin-canvas-wire-body"><!-- wp:group {"className":"origin-canvas-wire-blk"} -->
<div class="wp-block-group origin-canvas-wire-blk"></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group origin-canvas-wire-body origin-canvas-wire-body--grid"><!-- wp:group {"className":"origin-canvas-wire-blk"} -->
<div class="wp-block-group origin-canvas-wire-blk"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-wire-blk"} -->
<div class="wp-block-group origin-canvas-wire-blk"></div>
<!-- /wp:group -->
...
<div class="wp-block-group origin-canvas-wire-body origin-canvas-wire-body--col"><!-- wp:group {"className":"origin-canvas-wire-blk"} -->
<div class="wp-block-group origin-canvas-wire-blk"></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-bullet-mark"} -->
<div class="wp-block-group origin-canvas-bullet-mark"></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-token-sw","style":{"color":{"background":"var(--wp--preset--color--primary)"}}} -->
<div class="wp-block-group origin-canvas-token-sw has-background" style="background-color:var(--wp--preset--color--primary)"></div>
<!-- /wp:group -->
...
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-token-sw","style":{"color":{"background":"var(--wp--preset--color--text-heading)"}}} -->
<div class="wp-block-group origin-canvas-token-sw has-background" style="background-color:var(--wp--preset--color--text-heading)"></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-token-sw","style":{"color":{"background":"var(--wp--preset--color--text-body)"}}} -->
<div class="wp-block-group origin-canvas-token-sw has-background" style="background-color:var(--wp--preset--color--text-body)"></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-token-sw","style":{"color":{"background":"var(--wp--preset--color--surface-subtle)"}}} -->
<div class="wp-block-group origin-canvas-token-sw has-background" style="background-color:var(--wp--preset--color--surface-subtle)"></div>
<!-- /wp:group -->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"6px"}},"layout":{"type":"default"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-token-sw","style":{"color":{"background":"var(--wp--preset--color--border)"}}} -->
<div class="wp-block-group origin-canvas-token-sw has-background" style="background-color:var(--wp--preset--color--border)"></div>
<!-- /wp:group -->
...
<div class="wp-block-group origin-canvas-token-scale"><!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--1"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--1"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--2"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--2"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--3"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--3"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--4"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--4"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--5"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--5"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--6"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--6"></div>
<!-- /wp:group -->

<!-- wp:group {"className":"origin-canvas-token-bar origin-canvas-token-bar--7"} -->
<div class="wp-block-group origin-canvas-token-bar origin-canvas-token-bar--7"></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
...
<div class="wp-block-group" style="margin-top:0;margin-bottom:22px"><!-- wp:group {"className":"origin-canvas-status-dot"} -->
<div class="wp-block-group origin-canvas-status-dot"></div>
<!-- /wp:group -->
...
<div class="wp-block-column has-border-color has-border-border-color has-surface-base-background-color has-background" style="border-style:solid;border-width:1px;border-radius:var(--wp--custom--radius--large);padding-top:var(--wp--preset--spacing--large);padding-right:var(--wp--preset--spacing--large);padding-bottom:var(--wp--preset--spacing--large);padding-left:var(--wp--preset--spacing--large)"><!-- wp:group {"style":{"dimensions":{"minHeight":"258px"},"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"space-between"}} -->
<div class="wp-block-group" style="min-height:258px"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"className":"origin-canvas-status-chip origin-canvas-mono","style":{"spacing":{"margin":{"top":"0","bottom":"22px"}}}} -->
<p class="origin-canvas-status-chip origin-canvas-mono" style="margin-top:0;margin-bottom:22px"><?php echo esc_html__( 'Coming soon', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-group" style="min-height:258px"><!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group"><!-- wp:paragraph {"className":"origin-canvas-status-chip origin-canvas-status-chip--dark origin-canvas-mono","style":{"spacing":{"margin":{"top":"0","bottom":"22px"}}}} -->
<p class="origin-canvas-status-chip origin-canvas-status-chip--dark origin-canvas-mono" style="margin-top:0;margin-bottom:22px"><?php echo esc_html__( 'Coming soon', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- /wp:group --></section>
<!-- /wp:group -->
<!-- wp:group {"tagName":"footer","align":"full","backgroundColor":"surface-base","style":{"border":{"top":{"color":"var:preset|color|border","width":"1px"}},"spacing":{"padding":{"top":"var:preset|spacing|colossal","bottom":"var:preset|spacing|extra-large"}}},"layout":{"type":"constrained"}} -->
<footer class="wp-block-group alignfull has-surface-base-background-color has-background" style="border-top-color:var(--wp--preset--color--border);border-top-width:1px;padding-top:var(--wp--preset--spacing--colossal);padding-bottom:var(--wp--preset--spacing--extra-large)"><!-- wp:columns {"align":"wide","style":{"border":{"bottom":{"color":"var:preset|color|border","width":"1px"}},"spacing":{"padding":{"bottom":"var:preset|spacing|huge"}}}} -->
<div class="wp-block-columns alignwide" style="border-bottom-color:var(--wp--preset--color--border);border-bottom-width:1px;padding-bottom:var(--wp--preset--spacing--huge)"><!-- wp:column {"width":"35%"} -->
<div class="wp-block-column" style="flex-basis:35%"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|compact"}},"layout":{"type":"flex","verticalAlignment":"center"}} -->
<div class="wp-block-group"><!-- wp:group {"className":"origin-canvas-brand-mark"} -->
<div class="wp-block-group origin-canvas-brand-mark"></div>
<!-- /wp:group -->
...
<!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"var:preset|spacing|medium"}}},"textColor":"text-muted","fontSize":"small"} -->
<p class="has-text-muted-color has-text-color has-small-font-size" style="margin-top:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'A Full Site Editing block theme for WordPress. Templates, patterns, and styles that work as one system.', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column {"width":"65%"} -->
<div class="wp-block-column" style="flex-basis:65%"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"textColor":"text-heading","fontSize":"extra-small","style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0.02em"},"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}}} -->
<p class="has-text-heading-color has-text-color has-extra-small-font-size" style="margin-bottom:var(--wp--preset--spacing--small);font-style:normal;font-weight:600;letter-spacing:0.02em"><?php echo esc_html__( 'Theme', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:group {"className":"has-small-font-size","style":{"spacing":{"blockGap":"var:preset|spacing|compact"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Features', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Patterns', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Style Variations', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Templates', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Changelog', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"textColor":"text-heading","fontSize":"extra-small","style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0.02em"},"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}}} -->
<p class="has-text-heading-color has-text-color has-extra-small-font-size" style="margin-bottom:var(--wp--preset--spacing--small);font-style:normal;font-weight:600;letter-spacing:0.02em"><?php echo esc_html__( 'Resources', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:group {"className":"has-small-font-size","style":{"spacing":{"blockGap":"var:preset|spacing|compact"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Documentation', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Live demo', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Starter content', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Support', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:paragraph {"textColor":"text-heading","fontSize":"extra-small","style":{"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0.02em"},"spacing":{"margin":{"bottom":"var:preset|spacing|small"}}}} -->
<p class="has-text-heading-color has-text-color has-extra-small-font-size" style="margin-bottom:var(--wp--preset--spacing--small);font-style:normal;font-weight:600;letter-spacing:0.02em"><?php echo esc_html__( 'Project', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:group {"className":"has-small-font-size","style":{"spacing":{"blockGap":"var:preset|spacing|compact"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-small-font-size"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'GitHub', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'WordPress.org', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'License (GPL)', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|text-body"},"typography":{"textDecoration":"none"}}}},"textColor":"text-body"} -->
<p class="has-text-body-color has-text-color has-link-color"><a href="#" style="text-decoration:none"><?php echo esc_html__( 'Contributing', 'origin-canvas' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<div class="wp-block-group alignwide"><!-- wp:paragraph {"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"text-muted","fontSize":"extra-small"} -->
<p class="has-text-muted-color has-text-color has-extra-small-font-size" style="margin-top:0;margin-bottom:0"><?php echo esc_html__( '&copy; 2026 Origin Canvas. Released under the GPL.', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"className":"origin-canvas-mono","style":{"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"text-muted","fontSize":"extra-small"} -->
<p class="origin-canvas-mono has-text-muted-color has-text-color has-extra-small-font-size" style="margin-top:0;margin-bottom:0"><?php echo esc_html__( 'v1.0 &middot; WordPress 6.5+ &middot; theme.json v3', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></footer>
<!-- /wp:group -->
