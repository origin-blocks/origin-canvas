...
<h2 class="wp-block-heading has-text-align-center has-huge-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( '61 patterns. 14 categories. One design language.', 'origin-canvas' ); ?></h2>
<!-- /wp:heading -->
