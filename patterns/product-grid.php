...
<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--huge)"><!-- wp:heading {"textAlign":"center","level":2,"style":{"typography":{"lineHeight":"1.08","fontSize":"clamp(2.1rem, 4.4vw, 3rem)"},"spacing":{"margin":{"top":"0","bottom":"var:preset|spacing|medium"}}}} -->
<h2 class="wp-block-heading has-text-align-center" style="font-size:clamp(2.1rem, 4.4vw, 3rem);margin-top:0;margin-bottom:var(--wp--preset--spacing--medium);line-height:1.08"><?php echo wp_kses_post( __( 'Start with the foundation.<br>Add layers as you need them.', 'origin-canvas' ) ); ?></h2>
<!-- /wp:heading -->
...
<p class="has-text-body-color has-text-color" style="margin-top:0;margin-bottom:22px;font-size:0.90625rem;line-height:1.55"><?php echo esc_html__( 'A modern, opinionated FSE theme with a finished design baseline, 61 patterns, and 11 style variations, ready on install.', 'origin-canvas' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
