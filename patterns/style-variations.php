...
<h2 class="wp-block-heading has-text-align-center has-huge-font-size" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--medium)"><?php echo wp_kses_post( __( 'Eleven style variations.<br>One click to reskin.', 'origin-canvas' ) ); ?></h2>
<!-- /wp:heading -->
