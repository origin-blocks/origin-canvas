...
<h2 class="wp-block-heading" style="margin-top:0;margin-bottom:var(--wp--preset--spacing--small)"><?php echo esc_html__( 'Eight years of brand and web work', 'origin' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"text-body","fontSize":"regular-plus"} -->
<p class="has-text-body-color has-text-color has-regular-plus-font-size"><?php echo esc_html__( 'Take a look at what we&#8217;ve made for businesses like yours. Most projects start with a single email.', 'origin' ); ?></p>
<!-- /wp:paragraph -->
