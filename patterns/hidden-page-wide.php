 ...
 * Slug: origin-canvas/hidden-page-wide
 * Categories: hidden
 * Inserter: no
 *
 * @package Origin
...
<main class="wp-block-group" style="margin-top:var(--wp--preset--spacing--colossal);margin-bottom:var(--wp--preset--spacing--massive)"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|medium"}},"layout":{"type":"constrained"}} -->
