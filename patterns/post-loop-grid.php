...
?>
<!-- wp:query {"queryId":1,"query":{"perPage":10,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","inherit":true},"align":"wide","className":"origin-post-loop-grid origin-posts\u002d\u002dstretch","layout":{"type":"default"}} -->
<div class="wp-block-query alignwide origin-post-loop-grid origin-posts--stretch"><!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|extra-large","margin":{"bottom":"var:preset|spacing|jumbo"}}},"layout":{"type":"grid","columnCount":3}} -->
<!-- wp:post-featured-image {"isLink":true,"aspectRatio":"3/2","className":"origin-featured-fallback","style":{"spacing":{"margin":{"top":"0px","bottom":"0px"}},"border":{"radius":{"topLeft":"8px","topRight":"8px","bottomLeft":"var:preset|border-radius|medium","bottomRight":"var:preset|border-radius|medium"}}}} /-->
