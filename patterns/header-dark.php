...
<!-- wp:navigation {"overlay":"mobile-menu-dark","textColor":"on-dark","className":"origin-canvas-main-nav origin-canvas-nav-dark is-style-origin-canvas-hover-accent","style":{"spacing":{"blockGap":"var:preset|spacing|extra-large"},"typography":{"fontWeight":"500","fontStyle":"normal"}},"fontSize":"small","layout":{"type":"flex","justifyContent":"center","flexWrap":"wrap"}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
