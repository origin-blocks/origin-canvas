...
<h1 class="wp-block-heading has-text-align-center has-display-2xl-font-size" style="margin-top:0;margin-bottom:0"><?php echo esc_html__( 'A small studio for brand and web work.', 'origin-canvas' ); ?></h1>
<!-- /wp:heading -->
