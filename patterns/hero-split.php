...
<div class="wp-block-cover is-light" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;min-height:100%"><img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'A bright studio interior with an arched window, plants, and papers on a wooden worktable.', 'origin' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/patterns/images/architecture-interior.webp" data-object-fit="cover"/><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim"></span><div class="wp-block-cover__inner-container"><!-- wp:paragraph {"align":"center","placeholder":"Write title…","fontSize":"large"} -->
...
<p class="has-text-align-left has-primary-color has-text-color has-small-font-size" style="margin-bottom:var(--wp--preset--spacing--small);font-weight:500;letter-spacing:0.08em;text-transform:uppercase"><?php echo esc_html__( 'WHAT WE DO', 'origin' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"left","level":1,"style":{"spacing":{"margin":{"top":"0","bottom":"0"}}}} -->
<h1 class="wp-block-heading has-text-align-left" style="margin-top:0;margin-bottom:0"><?php echo esc_html__( 'Brand identity and websites for small businesses.', 'origin' ); ?></h1>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"left","textColor":"text-body","fontSize":"regular-plus"} -->
<p class="has-text-align-left has-text-body-color has-text-color has-regular-plus-font-size"><?php echo esc_html__( 'Roughly twelve projects a year. Each one starts with a conversation, ends with a launch checklist, and lives somewhere we&#8217;re proud to send people.', 'origin' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Recent work', 'origin' ); ?></a></div>
<!-- /wp:button -->

<!-- wp:button {"className":"is-style-outline-strong"} -->
<div class="wp-block-button is-style-outline-strong"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Our process', 'origin' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></section>
