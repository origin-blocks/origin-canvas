...
<h3 class="wp-block-heading has-huge-font-size has-text-color" style="margin-top:0;margin-bottom:0;color:#F3F4F6"><?php echo esc_html__( 'Have a project in mind?', 'origin-canvas' ); ?></h3>
<!-- /wp:heading -->
