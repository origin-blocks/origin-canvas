...
<h2 class="wp-block-heading has-text-align-center" style="font-size:clamp(2rem, 4vw, 2.75rem);margin-top:0;margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'Every template, ready to shape in the editor.', 'origin-canvas' ); ?></h2>
<!-- /wp:heading -->
