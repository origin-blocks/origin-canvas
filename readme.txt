...
Pattern image "Week-one client brief image" (patterns/images/card-blog-1.webp), AI-generated for Origin Canvas using OpenAI/ChatGPT image generation. Released by Origin under GPLv3. Provider terms: OpenAI Terms of Use, https://openai.com/policies/terms-of-use/.
...
Pattern image "Marcus Reed team portrait" (patterns/images/avatar-marcus-reed.webp), AI-generated for Origin Canvas using OpenAI/ChatGPT image generation. Released by Origin under GPLv3. Provider terms: OpenAI Terms of Use, https://openai.com/policies/terms-of-use/.

Pattern image "Grace Whitfield team portrait" (patterns/images/avatar-grace-whitfield.webp), AI-generated for Origin Canvas using OpenAI/ChatGPT image generation. Released by Origin under GPLv3. Provider terms: OpenAI Terms of Use, https://openai.com/policies/terms-of-use/.
...
- Inter: Used for body text and headings in the default style. Available in normal and italic at 400, 500, 600, and 700 weights. Source: [Google Fonts](https://fonts.google.com/specimen/Inter) licensed under [SIL Open Font License 1.1](https://scripts.sil.org/OFL).

- DM Sans: Used by the Refined Sans style variation. Source: [Google Fonts](https://fonts.google.com/specimen/DM+Sans) licensed under [SIL Open Font License 1.1](https://scripts.sil.org/OFL).

- Space Grotesk: Used by the Expressive style variation. Source: [Google Fonts](https://fonts.google.com/specimen/Space+Grotesk) licensed under [SIL Open Font License 1.1](https://scripts.sil.org/OFL).

- Source Serif 4: Used by the Editorial style variation. Source: [Google Fonts](https://fonts.google.com/specimen/Source+Serif+4) licensed under [SIL Open Font License 1.1](https://scripts.sil.org/OFL).
...
* Added a Cards pattern category and fixed four card patterns that previously appeared under Uncategorized.
* Added a transitional compatibility shim that rewrites legacy card image paths so existing content keeps rendering after the asset move (sunset planned for a later release).
